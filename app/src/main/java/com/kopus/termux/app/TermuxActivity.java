...
import com.termux.kopus.R;
import com.termux.kopus.terminal.EmulatorDebug;
import com.termux.kopus.terminal.TerminalColors;
import com.termux.kopus.terminal.TerminalSession;
import com.termux.kopus.terminal.TerminalSession.SessionChangedCallback;
import com.termux.kopus.terminal.TextStyle;
import com.termux.kopus.view.TerminalView;
...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public static final String TERMUX_FAILSAFE_SESSION_ACTION = "com.termux.kopus.app.failsafe_session";
    ...
    private static final String RELOAD_STYLE_ACTION = "com.termux.kopus.app.reload_style";
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/com.termux.kopus/files/home/.termux/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/com.termux.kopus/files/home/.termux/colors.properties");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case CONTEXTMENU_STYLING_ID: {
                ...
                stylingIntent.setClassName("com.termux.kopus.styling", "com.termux.kopus.styling.TermuxStyleActivity");
                try {
                    ...
                    new AlertDialog.Builder(this).setMessage(R.string.styling_not_installed)
                        .setPositiveButton(R.string.styling_install, (dialog, which) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.termux.kopus.styling")))).setNegativeButton(android.R.string.cancel, null).show();
                }
                return true;
            }

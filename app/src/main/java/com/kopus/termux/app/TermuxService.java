...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/com.termux.kopus/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "com.termux.kopus.service_stop";
    private static final String ACTION_LOCK_WAKE = "com.termux.kopus.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "com.termux.kopus.service_wake_unlock";
    /** Intent action to launch a new terminal session. Executed from TermuxWidgetProvider. */
    public static final String ACTION_EXECUTE = "com.termux.kopus.service_execute";

    public static final String EXTRA_ARGUMENTS = "com.termux.kopus.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "com.termux.kopus.execute.cwd";
    public static final String EXTRA_EXECUTE_IN_BACKGROUND = "com.termux.kopus.execute.background";
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        Intent stylingIntent = new Intent("com.termux.kopus.app.reload_style");
        stylingIntent.putExtra("com.termux.kopus.app.reload_style", "styling");
